...
import type { Command } from "./command-menu/types.js";
import { useCommandMenu } from "./command-menu/use-command-menu.js";
...
export function InputBar({ onSubmit, disabled = false }: Props) {
  const { mode, toggleMode, setMode, setModel, setThinkingLevel } =
    usePromptConfig();
